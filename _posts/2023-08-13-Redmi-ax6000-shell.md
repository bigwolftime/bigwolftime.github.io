...
下图是我拿到手之后的版本(1.0.67):
![我的出厂版本](https://img.zonheng.net/tech/redmi_ax6000_version.png-thumbnail)

根据恩山论坛帖子介绍, 1.0.67 支持解 SSH, 无需刷入其他版本(若有特殊版本需求可以进入固件集合链接下载).
![Redmi AX6000 支持开启 SSH 版本](https://img.zonheng.net/tech/redmi_ax6000_support_ssh_version.png-thumbnail)
...
![Redmi AX6000 telnet](https://img.zonheng.net/tech/redmi_ax6000_telnet.png-thumbnail)
